      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="space-y-4 relative z-10 text-left">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              I am a dedicated Computer Science student with a deep passion for Full Stack Development. As a MERN Stack Enthusiast, I specialize in building highly responsive, scalable web platforms that blend robust database logistics with clean backend services and polished client-side interfaces.
            </p>
            <p className="text-white/60 text-sm leading-relaxed">
          ...
          <div className="flex flex-wrap gap-3 pt-4 relative z-10">
            <span className="text-[10px] font-mono px-3 py-1 rounded-full bg-white/5 border border-white/10 text-white/70">COMPUTER SCIENCE STUDENT</span>
        ...
        >
          ...
          <div className="text-[10px] text-white/45 bg-white/5 p-2 rounded-lg border border-white/10 mt-4 text-left leading-relaxed">
            ⚡ Playstyle: Speed wing-run + precision assists. Brings stamina and strategic team alignment into development sprints.
          </div>
        </motion.div>
